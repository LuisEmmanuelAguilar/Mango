    ...
    public class OrderService : IOrderService
    {
        ...
        public async Task<ResponseDto?> GetAllOrders(string? userId)
        {
            return await _baseService.SendAsync(new RequestDto()
            {
                ...
                Url = StandardDetails.OrderAPIBase + "/api/order/GetOrders?userId=" + userId
            });
        }
        ...
        public async Task<ResponseDto?> GetOrder(int orderId)
        {
            ...
            {
                ApiType = StandardDetails.ApiType.GET,
                Url = StandardDetails.OrderAPIBase + "/api/order/GetOrder/" + orderId
            });
        }
        ...
        public async Task<ResponseDto?> UpdateOrderStatus(int orderId, string newStatus)
        {
            return await _baseService.SendAsync(new RequestDto()
            {
                ApiType = StandardDetails.ApiType.POST,
                Data = newStatus,
                Url = StandardDetails.OrderAPIBase + "/api/order/UpdatOrderStatus/" + orderId
            });
        }
